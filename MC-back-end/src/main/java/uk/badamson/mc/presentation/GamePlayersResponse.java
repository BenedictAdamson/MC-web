...
public class GamePlayersResponse {
    ...
    public static boolean isValidUsers(final Map<UUID, UUID> users) {
        return users != null
                ...
                .allMatch(GamePlayersResponse::isValidUsersEntry)
    ...
    @JsonCreator
    @PersistenceCreator
    public GamePlayersResponse(@Nonnull @JsonProperty("game") final Game.Identifier game,
     ...
     */
    public GamePlayersResponse(@Nonnull final GamePlayersResponse that) {
     ...
     * </p>
     * <ul>
     * <li>The {@link GamePlayersResponse} class has <i>entity semantics</i>, with the
     ...
     * is also a {@link GamePlayersResponse} and the two have
