...
final class McFrontEndContainer extends GenericContainer<McFrontEndContainer> {
   ...
   private static final Path CONF = Paths
            .get("src/main/resources/usr/local/apache2/conf");

   private static final Path WEB = Paths
            .get("src/main/web/mc-front-end/dist/mc-front-end");
   ...
   private static ImageFromDockerfile createImage(final String version) {
      return new ImageFromDockerfile()
               ...
               .withFileFromPath("src/main/resources/usr/local/apache2/conf",
                        CONF)
               .withFileFromPath("src/main/web/mc-front-end/dist/mc-front-end",
                        WEB)
